    ...
    <HeroWrapper className="relative">
      ...
      <div className="container flex flex-col items-center h-full px-6 mx-auto pt-36 isolate xl:pt-40">
        <div className="pb-8">
          ...
          <p className="hero-text font-['Gilroy'] font-[400] text-center text-base text-black-1 max-w-xs md:text-lg md:max-w-md lg:text-xl lg:max-w-xl xl:text-2xl xl:max-w-3xl">
      ...
      <div className="relative mt-20 h-[480px] w-full overflow-hidden flex justify-center lg:h-[700px] xl:h-[800px]">
        <div className="absolute flex h-full gap-[8px] lg:relative lg:grid lg:grid-cols-[repeat(2_,1fr)] lg:content-center lg:justify-items-center">
