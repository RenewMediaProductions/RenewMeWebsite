      ...
      >
        ...
        <div
          className={classNames(
            ...
            `md:left-[calc(50%+250px/2)] md:w-[230px] md:translate-x-[-50%]`,
        ...
        >
          ...
          >
            Discover an oasis of wellness resources designed to help you maintain a healthier mind,
            body, and soul while traveling to your favorite beautiful destinations.
          </p>
        </div>
      </div>
    </Service3Wrapper>
