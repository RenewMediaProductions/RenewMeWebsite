...
const Service5: React.FC<Props> = ({ className }) => {
  const serviceClass = classNames(
    `relative h-[650px] mt-[-75px]`,
    `md:h-[922px] md:mt-[-90px]`,
    `lg:h-[1000px] lg:mt-[-50px]`,
    className
  );
  ...
  const phone2Class = classNames(
    ...
    `md:left-[50%] md:top-[calc(50%_-_150px)] md:max-w-[330px] md:absolute md:translate-x-[-50%] md:translate-y-[-50%]`,
  ...
  const infoClass = classNames(
    ...
    `md:items-start md:left-[50%] md:top-[calc(50%_+_265px)] md:w-[220px] md:absolute md:translate-x-[-50%] md:translate-y-[-50%]`,
    `lg:top-[calc(50%_+_430px)] lg:w-[315px]`
  );
    ...
    <Service5Wrapper className={serviceClass}>
      ...
      <div className={contentClass}>
        ...
        <div className={infoClass}>
          ...
          <p className="font-['Gilroy'] font-[600] text-lg text-black-1 text-center md:w-[160px] md:text-start md:text-xl lg:text-2xl">
