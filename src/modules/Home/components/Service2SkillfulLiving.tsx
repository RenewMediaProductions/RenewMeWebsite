...
import { Service2WrapperSkillfulLiving } from './Service2SkillfulLiving.styled';

interface Props {
  className?: string;
}

const Service2SkillfulLiving: React.FC<Props> = ({ className }) => {
  return (
...
export default Service2SkillfulLiving;
